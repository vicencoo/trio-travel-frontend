  ...
  return (
    <div className="grid md:grid-cols-8 grid-cols-7 items-center px-4 py-1 border-b border-gray-300 dark:border-slate-700 last:border-b-0">
      ...
      <Text
        ...
        className="col-span-2 uppercase px-2 truncate text-slate-900 dark:text-slate-300"
      />
      <Text
        text={packageItem.destination}
        size="text-sm"
        font="font-medium"
        className="hidden md:flex col-span-2 uppercase text-slate-800 dark:text-slate-400"
      />
      <Text
