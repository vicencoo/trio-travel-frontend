  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full p-4 gap-4 max-h-[75vh] overflow-y-auto">
        ...
        <div>
          <Text
            text={"Kompania e Fluturimit"}
            font="font-semibold"
            size="text-sm"
            className={"text-slate-900 dark:text-slate-300"}
          />
          <Selector
            name="flight_company_id"
            label="Kompania e Fluturimit"
            disablePortal
            options={
            ...
            value={String(formData.flight_company_id || "")}
            onChange={handleChangeCompany}
            errorMessage={errors.flight_ticket_id}
          />
        </div>
        <Input
          label="Shuma Totale (€) *"
