...
export const BookingRow = ({
  ...
  return (
    <div className="grid grid-cols-6 items-center px-4 py-3 border-b border-gray-300 dark:border-slate-700 last:border-b-0 md:gap-0 gap-1 bg-white/60 dark:bg-slate-800">
      <div className="md:col-span-1 col-span-2 flex items-center gap-2">
        <Text
      ...
      <Text
        text={booking.flight_company?.flight_company}
        size="md:text-sm text-xs"
        font="font-medium"
        className="hidden md:flex capitalize col-span-1 text-blue-700 dark:text-slate-300"
      />
      <Text
      ...
      <Text
        ...
        className="hidden md:flex col-span-1 text-green-600 dark:text-slate-300"
      />
      <div className="flex md:flex-row flex-col gap-0 md:gap-2 truncate col-span-1">
        <Text
          text={date}
          size="md:text-sm text-xs"
          font="font-medium"
