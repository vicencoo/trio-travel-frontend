...
export const PackageCard = ({ data, index }: PackageCardProps) => {
  ...
  return (
    <div
      className="flex flex-col border h-[540px] rounded-3xl overflow-hidden bg-white relative shadow-sm cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300 will-change-transform group select-none"
    ...
    >
      <Image
        ...
        className="h-[360px] object-cover group-hover:scale-105 transition-all duration-300"
      />
