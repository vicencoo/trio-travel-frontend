          ...
          <div ref={wrapperRef}>
            ...
            >
              ...
              <div className="flex flex-col gap-1 px-5 py-2">
                <div className="flex items-center gap-2 text-gray-500 dark:text-slate-300 p-3 bg-transparent hover:bg-gray-200 dark:hover:bg-slate-500 dark:hover:text-slate-100 transition-colors duration-200 rounded-xl cursor-not-allowed">
                  <Settings size={14} />
                  <Text
